            ...
            <div className = "about-me-page bg-filter justify-center mt-10">
                ...
                <div className ="flex flex-wrap justify-center">
                    ...
                    <div className = "about-me-text-container p-2 m-2 text-left">
                        ...
                        <p> I would love the opportunity to put my skillset to use, I have a strong background in the Australian public health system with almost 20 years experience across clinical and digital health roles. While my skillset is well suited to digital health, I am also open to venturing into new territories to broaden my knowledge.</p>                        
